...
//              ),
      ...
      bottomNavigationBar: Container(
        height: (!isEmotionPanelShow && !isKeyboardShow)
            ? 48
            : 48 + emotionPanelHeight,
...
//                              '@ ';
//                      _controller.text = textHead +
//                          text.substring(_controller.selection.baseOffset);
//                      _controller.selection = TextSelection.fromPosition(
//                          TextPosition(offset: textHead.length - 1));
//                      rawText = _controller.text;
//                    },
//                    color: Colors.transparent,
//                  ),
...
//                    width: 48,
//                    child: Icon(
//                      isKeyboardShow ? Icons.tag_faces : Icons.keyboard,
//                      color: _theme.primaryColor,
//                    ),
//                    padding: EdgeInsets.all(0),
//                    shape: Border(),
...
//                        text.substring(_controller.selection.baseOffset);
//                    _controller.selection = TextSelection.fromPosition(
//                        TextPosition(offset: textHead.length));
//                    rawText = _controller.text;
//                  },
//                ),
//              ),
...
//              actionBarTitleColor: '#' +
//                  _theme.primaryTextTheme.bodyText1.color.value
//                      .toRadixString(16)));
...
//        var _key = GlobalKey();
//        return Stack(key: _key, fit: StackFit.expand, children: <Widget>[
//          tumb,
